...
def run_softmax_on_MNIST_reduction(train_pca, test_pca, train_y, test_y, temp_parameter=1):
    """
    Trains Softmax regression on digit classifications with less dimentions.
...
print('softmax reduction test_error=', run_softmax_on_MNIST_reduction(train_pca, test_pca, train_y, test_y, temp_parameter=1))
...
def run_softmax_on_MNIST_cube(train_pca, test_pca, train_y, test_y, temp_parameter=1):
    """
    Trains Softmax regression on digit classifications with less dimentions.
...
print('softmax cube test_error=', run_softmax_on_MNIST_cube(train_cube, test_cube, train_y, test_y, temp_parameter=1))
